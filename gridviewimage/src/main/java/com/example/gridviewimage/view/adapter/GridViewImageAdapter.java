...
public class GridViewImageAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Glide.with(context).load(gridItemList.get(position)).diskCacheStrategy(DiskCacheStrategy.ALL).crossFade().thumbnail(0.1f).error(R.mipmap.image_error).placeholder(R.mipmap.loading).into(viewHolder.image);
